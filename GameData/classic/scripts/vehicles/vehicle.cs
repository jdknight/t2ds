...
function MobileBaseVehicle::checkTurretDistance(%data, %obj)
{
    ...
    InitContainerRadiusSearch(%pos, 20, $TypeMasks::TurretObjectType |
        $TypeMasks::InteriorObjectType); // z0dd - ZOD, 6/21/02. Allow closer deploy. Was 100
    while ((%objFound = ContainerSearchNext()) != 0)
    {
        ...
        %position, %amount, %damageType, %momVec, %theClient, %proj)
{
    ...
    else
    {
        ...
        // Client is already defined and this spams console - ZOD
